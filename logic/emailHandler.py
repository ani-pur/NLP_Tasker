  ...
  <body style="margin:0;padding:0;background-color:#f6f7f9;">
    <div style="max-width:600px;margin:40px auto;background:#ffffff;
      ...
      <div style="padding:22px 22px;font-size:14px;">
        <h2 style="margin:10px 0 6px 0;font-size:18px;line-height:1.25;">
          Hi <span style="font-weight:900;">${username}</span>,
        </h2>

        <p style="margin:0 0 14px 0;color:#334155;">
          Your Tasker account has been approved.
        </p>
        ...
        <div style="text-align:center;margin:18px 0 22px 0;">
          ...
          <div style="margin-top:8px;font-size:11px;color:#64748b;">
            Manual redirect:
            <a href="${login_url}" style="color:#2563eb;text-decoration:none;">
              ${login_url}
            </a>
          </div>
        </div>
        ...
        <p style="margin:0;font-size:13px;color:#475569;">
          Updates and README:
          <a href="${readme_url}" style="color:#2563eb;text-decoration:none;font-weight:700;">
            GitHub
          </a>
        </p>

        <p style="margin:10px 0 0 0;font-size:13px;color:#475569;">
          Something broke? Got a feature idea? Respond to this email!
        </p>

        <p style="margin:14px 0 0 0;font-size:13px;">
          Thanks,<br>
          <strong>Anirudh</strong><br>
          <span style="color:#64748b;">Tasker Admin</span>
        </p>
      </div>
      ...
      <div style="padding:14px 22px;background:#f8fafc;border-top:1px solid #eef2f7;">
        <p style="margin:0;font-size:11px;color:#64748b;">
          Automated email. Replies go straight to me.<br>
          pls give internship
        </p>
      </div>
...
if notify_admin:
    msg["Subject"] = "Tasker: account request received"
    msg["From"] = FROM_ADDR
    msg["To"] = ADMIN_ADDR
