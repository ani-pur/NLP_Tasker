...
- Extract ONLY these fields from the user input (provided below) as a pretty JSON object:
    ...
    1. task_name [required]: Paraphrase a short task title (no more than 6 words) from user input that does not include day/date information, just paraphrase a SHORT apt title.
