...
- Extract ONLY these fields from the user input as a JSON object:
    ...
    4. due_date [required]: Always resolve to an absolute date. If input has relative date/time ("in 5 hours", "tomorrow"), use the appended metadata (provided below) to calculate. Format: 'DD Mon YYYY' (e.g., "01 Jul 2025").
